...
public class PlayerController : MonoBehaviour
{
    ...
    public void SpawnPlayer()
    {
        ...
        if(GlobalManager.LevelManager.currentPlatformList.Count != 0)
        {
            tr.position = GlobalManager.LevelManager.currentPlatformList[GlobalManager.LevelManager.currentPlatformList.Count / 2].transform.position;
            GlobalManager.LevelManager.currentPlatformList.RemoveAt(GlobalManager.LevelManager.currentPlatformList.Count / 2);
        }
        else
        {
